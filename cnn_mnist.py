...
#    Convolutional Layer #1: Applies 32 5x5 filters (extracting 5x5-pixel
#        subregions), with ReLU activation function
#    Pooling Layer #1: Performs max pooling with a 2x2 filter and stride
...
def cnn_model_fn(features, labels, mode):
    ...
    # Logits Layer (Dense Layer #2 which is the 10 neurons, one for each digit)
...
def main(unused_argv):
    ...
    mnist_classifier.train(
        ...
        steps = 20000, #TODO change to 20000
        hooks=[logging_hook])
